...
#
# Taken from https://github.com/microsoft/unilm/blob/master/dit/object_detection/train_net.py
# Ajax adapted for fine-tuning on Ajax's context-specific screenshots
# --------------------------------------------------------------------------------
